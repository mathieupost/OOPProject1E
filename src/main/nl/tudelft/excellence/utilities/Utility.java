...
public class Utility {
    ...
    public static boolean isBoolean(String in) {
        return in.trim().equalsIgnoreCase("true") || in.trim().equalsIgnoreCase("false");
    }
     ...
     * @return The classes
     */
    private static TreeSet<String> findClasses(String path, String packageName, Pattern exclusionRegex) throws Exception {
        TreeSet<String> classes = new TreeSet<String>();
