...
public class SpreadSheetTest {
	...
	public void testGetCells() {
		Cell[] test1 = s1.getCells("A1", "B2");
		assertEquals(test1[0], s1.getCell(1,1));
		assertEquals(test1[1], s1.getCell(1,2));
		assertEquals(test1[2], s1.getCell(2,1));
		assertEquals(test1[3], s1.getCell(2,2));	
		assertNull(s1.getCells("A1","not valid"));
		assertNull(s1.getCells("also not valid","B2"));
	}
	...
	public void testSaveFile() {
		...
		} catch (SaveNotNeededException e) {fail();}
	}
